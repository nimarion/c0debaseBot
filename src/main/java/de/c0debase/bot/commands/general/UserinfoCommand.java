...
public class UserinfoCommand extends Command {
    ...
    public void execute(final String[] args, final Message message) {
        ...
        embedBuilder.addField("Spiel",
                member.getActivities().isEmpty() ? "---" : member.getActivities().get(0).getName(), true);
        ...
        embedBuilder.addField("Erstelldatum: ",
                member.getUser().getTimeCreated().format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")), true);
